package pl.karolsiwek.aoc2021.day22;
...
public class Day22a {
    ...
    static Map<Coordinates, Boolean> results = new HashMap<>();

    static Integer MIN = -50;
    static Integer MAX = 50;

    public static void main(String[] args) {
        String[] lines = mainInput.split("\n");
        int n = 0;
        for (String line : lines) {
            System.out.println(n++ + "/" + line.length());

            String[] data = line.trim().split("[\\ =\"..\",]");
            Boolean trigger = data[0].equals("on");
            ...
            int z1 = Integer.parseInt(data[10]);
            int z2 = Integer.parseInt(data[12]);

            for (int i = Math.max(MIN, x1); i <= Math.min(MAX, x2); i++) {
                for (int j = Math.max(MIN, y1); j <= Math.min(MAX, y2); j++) {
                    for (int k = Math.max(MIN, z1); k <= Math.min(MAX, z2); k++) {
                        results.put(new Coordinates(i, j, k), trigger);
                    }
                }
            }
        }
        System.out.println(results.values().stream().filter(Boolean.TRUE::equals).count());
    }
    ...
    static String testInput = "on x=-20..26,y=-36..17,z=-47..7\n" +
    ...
    static String testInput2 = "    on x=10..12,y=10..12,z=10..12\n" +
            "    on x=11..13,y=11..13,z=11..13\n" +
            "    off x=9..11,y=9..11,z=9..11\n" +
            "    on x=10..10,y=10..10,z=10..10";

    static String mainInput = "on x=-45..0,y=-44..9,z=-39..10\n" +
