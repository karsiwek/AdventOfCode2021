...
public class Day14b {
    ...
    public static void main(String[] args) {
        ...
        polymer = growPolymer("HBHVVNPCNFPSVKBPPCBH", rules, 16);
...
//not 1865428 - too low
    ...
    private static void getStats(String chain) {
        Arrays.stream(chain.split("")).collect(Collectors.toMap(e-> e, e->1l, (a,b) -> a+b)).entrySet().stream().map(entry -> entry.getKey() + ";" + entry.getValue()).sorted()
